...
#     case.cov_algo = "drunkwalk_pprobe"
    ...
    case = Case("DrunkWalk_BiasedRandom", "./ArenaMaps/7room_slam_map_small.bmp")
...
#     case.cov_algo = "drunkwalk_biased"
    ...
    case.noise_mag = 20
    case.fail_prob = 0  
    case.random_bias_prob = 0.0 

    
    # Particle filter settings
    case.stop_on_all_covered = True
    case.num_particles = 100
    case.init_p_wt = 1/float(case.num_particles) #added by xinlei
